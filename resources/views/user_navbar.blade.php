                ...
                <div class="main-menu-content">
                        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                                ...
                                href="/managerecentinventory" data-i18n="2 columns">Recent Inventory</a>
                                                ...
                                                <li class="@if(\Request::is('searchfilter')) active @endif"><a
                                                ...
                                                <li class="@if(\Request::is('soldinventory')) active @endif"><a
                                                ...
                                                <li class="@if(\Request::is('soldapprovedinventory')) active @endif"><a
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="@if (\Request::is('soldapprovetransferinventory')) active @endif"><a
                                ...
                                <li class=" nav-item"><a href="#"><i class="feather icon-tv"></i><span
                                                        class="menu-title" data-i18n="Templates">Restore
                                                        Inventory</span></a>
                                        <ul class="menu-content">
                                                <li class="@if (\Request::is('restoremobiles')) active @endif"><a
                                                                class="menu-item" href="/restoremobiles"
                                                                data-i18n="1 columns">Restore Mobiles</a>
                                                </li>

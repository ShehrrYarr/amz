        ...
        <div class="navbar-wrapper">
            <div class="navbar-header">
                <ul class="nav navbar-nav flex-row">
                    ...
                    <li class="nav-item"><a class="navbar-brand" href="#"><img class="brand-logo" alt="stack admin logo" src="../../../app-assets/images/logo/stack-logo.png">
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="#"><i class="feather icon-book-open"></i><span class="menu-title" data-i18n="Templates">Inventory</span></a>
                    <ul class="menu-content">
                        ...
                        <li class="@if(\Request::is('searchfilter')) active @endif"><a class="menu-item" href="/searchfilter" data-i18n="4 columns">Search Filter</a>
                     </li>
                        ...
                        <li class="@if(\Request::is('soldinventory')) active @endif"><a class="menu-item" href="/soldinventory" data-i18n="5 columns">Sold Inventory</a>
                        </li>

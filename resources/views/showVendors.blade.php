            ...
            <div class="modal-body">
                <form class="form" id="storeMobile" action="{{ route('storeVendor') }}" method="post"
                    ...
                    <div class="form-body">
                        ...
                        {{-- <div class="mb-1">
                            <label for="mobile_no" class="form-label">Number Test</label>
                            <input type="number" min="1" class="form-control" id="vmobile_no" name="mobile_no" required>
                        </div> --}}
            ...
            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-12 latest-update-tracking mt-1 ">
                <div class="card ">
                    <div class="card-header latest-update-heading d-flex justify-content-between">
                        <h4 class="latest-update-heading-title text-bold-500">Available Vendors</h4>
